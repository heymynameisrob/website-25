---
title: Motion for UI
description: What I've learnt using motion on the web
...
import {
  ...
  StaggerButtonsDemo,
} from "@/components/post/motion/MotionDemos";

_This is a notebook of lessons I've learnt that I decided to share. Partly because it helps others learn and partly so I can come back to it when I need to refresh my memory._
...
```tsx title="CalendarTransition.tsx"
...
<ResponsiveContainerDemo client:visible />

```tsx title="ResponsiveContainer.tsx"
...
<StaggerButtonsDemo client:visible />

```tsx title="StaggeredButtons.tsx"
...
```tsx title="OffscreenAnimation.tsx"
...
```tsx title="ReducedMotionVideo.tsx"
...
```tsx title="LoadingAnimation.tsx"
...
```tsx title="FocusableAnimation.tsx"
<motion.div
