...
the platform to work _together_ to create a working environment that helps everyone from staff to patients.
...
<MediaWrapper
  src="https://ucarecdn.com/ee530e58-e254-40c8-a6b9-0f355acb75f6/"
  type="image"
  alt="A snapshot of Figma boards in our Web UI file. The design and engineering teams used this as visual reference as well as design guidelines on how to use components correctly."
/>
...
<MediaWrapper
  ...
  type="image"
  alt="Close-up shot of the UI showing the navigational tabs that organise the view below"
/>

From talking to _a lot_ of deparment managers, there are few things Lantum's Rota needs to be successful:
...
Even though _everybody_ complained about it, it was comfortable and you could move things around at will.
