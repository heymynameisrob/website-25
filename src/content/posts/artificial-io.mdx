...
import {
  ArtificialInboxFiltersDemo,
  ArtificialInboxTabsDemo,
  ArtificialInboxTasksDemo,
} from "@/components/post/artificial/ArtificialInboxDemos";
...
<ArtificialInboxFiltersDemo client:only="react" />
...
<ArtificialInboxTabsDemo client:only="react" />
...
<ArtificialInboxTasksDemo client:only="react" />
