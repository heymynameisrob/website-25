---
title: Artificial
description: How a small React component library helped Artificial prototype in code, use AI more effectively and ship production-quality interfaces faster.
image: "/src/assets/primitives-light.jpg"
imageDark: "/src/assets/primitives-dark.jpg"
date: 2025-03-01
type: "case-study"
company: artificial
hide: true
...
import { FilterMenuDemo } from "@/components/post/artificial/FilterMenuDemo";
...
<MediaWrapper
  src="https://ucarecdn.com/0c0d9f0a-00e2-4a45-96a7-0411beb3224a/"
  type="image"
  alt="Collection of UI primitives like buttons and dropdowns"
  caption="UI Primitives"
/>
...
<MediaWrapper
  src="https://ucarecdn.com/7387bb79-0b87-4620-b041-9bbbff0900a5/"
  type="video"
  alt="Video showing Storybook UI, with different components documented"
  caption="Documenting the primitives on Storybook"
/>
