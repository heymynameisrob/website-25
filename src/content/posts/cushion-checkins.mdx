...
Cushion is an async work communication app for distributed teams. We built it for teams tired of days dominated by busywork.
...
When writing their 'post', users can toggle if they want activity added to it or not. By clicking the ⚡ button, we run a batch job in our backend to fetch data from any connected sources. This helps link your update with real artefacts you've worked on that show progress during your workday. However, some days you don't have "something to show" in that way. Knowledge work means days of 'thinking things through' or even slow days. Making this optional takes the pressure off having to show something.
