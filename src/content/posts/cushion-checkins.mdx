---
title: Cushion
description: How we designed Cushion's checkins to help distributed teams share progress, stay accountable and reduce recurring status meetings.
...
import { CheckinDemo } from "@/components/post/cushion/CushionDemos";
